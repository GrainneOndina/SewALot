...
function PostEditForm() {
    ...
    const handleChangeImage = event => {
        ...
        if (file) {
            if (file.size > 2 * 1024 * 1024) {
                ...
                setImageError('Image size exceeds the limit of 2MB.');
    ...
    />
    {errors.content && (
        <Form.Text id="contentError" className="ErrorMessage">
            {errors.content.join(", ")}
        </Form.Text>
    )}
</Form.Group>
...
<Form.Group controlId="postUrl">
    ...
    />
    {errors.url && (
        <Form.Text id="urlError" className="ErrorMessage">
            {errors.url.join(", ")}
        </Form.Text>
    )}
</Form.Group>
...
<Form.Group controlId="postImage">
    ...
    {imageError && (
        <Form.Text id="imageError" className="ErrorMessage">
            {imageError}
        </Form.Text>
    )}
</Form.Group>
